  Feature: Discuss web page in Process
   ...
   Scenario: To test the validation for discussion
    ...
    When I fill in the following:
     | discussion_discussion |  |
    When I choose "url_disc_radio"
    And I press "Discuss"
    Then I should see "Please enter url."
    When I fill in the following:
     | discussion_discussion | abcd |
    And I press "Discuss"
    Then I should see "Please enter valid url."
    When I fill in the following:
     | discussion_discussion | www.google.com |
    And I press "Discuss"
    ...
    When I fill in the following:
     | discussion_discussion |  |
    When I choose "non_url_disc_radio"
    And I press "Discuss"
    Then I should see "Please enter Comment/Question."
    When I fill in the following:
     | discussion_discussion | WOW |
    And I press "Discuss"
    And I wait 5 seconds
    Then I should see "Discussion posted sucessfully."
    ...
    When I fill in the following:
     | discussion_discussion | www.google.com |
    When I choose "url_disc_radio"
    And I follow "add_attachment_link"
    Then I should see "Description"
    And I press "Discuss"
    Then I should see "Please enter description."
    And I should see "Please select file."
    When I follow "remove_attachment_link"
   ...
   Scenario: To test the validation for discussion
    ...
    When I fill in the following:
     | discussion_discussion | abcd |
    When I choose "url_disc_radio"
    And I choose "discuss_with_group"
    And I press "Discuss"
   ...
   Scenario: See discussion web page functionality
    ...
    Then I should see "Discuss a web page"
    When I fill in the following:
     | discussion_discussion | http://www.google.com |
    And I press "Discuss"
    And I wait 5 seconds
    Then I should see "Google"
