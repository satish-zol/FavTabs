...
ActiveRecord::Schema.define(:version => 36) do
  ...
  add_index "discussion_groups", ["description"], :name => "index_discussion_groups_on_description", :length => {"description"=>255}
  add_index "discussion_groups", ["name"], :name => "index_discussion_groups_on_name"
  add_index "discussion_groups", ["user_id"], :name => "index_discussion_groups_on_user_id"
